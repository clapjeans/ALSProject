...
public class WordService implements IWordService {
    ...
    private IWordMapper wordMapper;
    ...
    @Override
    public List<DicDTO> doWordAnalysis(String text) throws Exception {
    ...
    //        log.info(this.getClass().getName()+"list에 들어간 값입니다"+rList.get(i));
    //    }

        List<DicDTO>wordList =wordMapper.WordSearch(rList);
        log.info("찾는게 이게 맞나요?  : "+wordList);
